...
if isa(a,'double') 
    ...
    if (am == 1)
        ...
        elseif (anx == b.nx)&&(any == b.ny)
            % matrix argument
            mtrx = minus_na_matrix_left(a,b.mtrx);
        else
    ...
    elseif (am == b.m)
        if (anx == 1)&&(any == 1)
            % scalar array
            mtrx = minus_a_scalar_left(a,b.mtrx);
        elseif (anx == b.nx)&&(any == b.ny)
            % matrix array
            mtrx = a - b.mtrx;
        else
...
elseif isa(b,'double')   
    ...
    if (bm == 1)
        ...
        elseif (a.nx == bnx)&&(a.ny == bny)
            % matrix argument
            mtrx = minus_na_matrix_right(a.mtrx,b);
        else
    ...
    elseif (a.m == bm)
        if (bnx == 1)&&(bny == 1)
            % scalar array
            mtrx = minus_a_scalar_right(a.mtrx,b);
        elseif (a.nx == bnx)&&(a.ny == bny)
            % matrix array
            mtrx = a.mtrx - b;
        else
...
elseif strcmp(class(a),class(b))
    if (a.m == b.m)
        if (a.nx == 1)&&(a.ny == 1)
            % a is a scalar
            mtrx = minus_a_scalar_left(a.mtrx,b.mtrx);
        elseif (b.nx == 1)&&(b.ny == 1)
            % b is a scalar
            mtrx = minus_a_scalar_right(a.mtrx,b.mtrx);
