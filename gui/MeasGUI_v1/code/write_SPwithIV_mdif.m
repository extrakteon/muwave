function mswp = write_SPwithIV_mdif(msweep,fname,handles,varargin)
...
if handles.instr.measure_dc1 && handles.instr.measure_dc2
    if  get(handles.RadioV1, 'Value')
        indep_names = {'V1_SET', 'V1', 'V2_SET', 'V2', 'I1', 'I2'};
    else
        indep_names = {'V2_SET', 'V2', 'V1_SET', 'V1',  'I1', 'I2'};        
    end
elseif handles.instr.measure_dc1
    indep_names = {'V1_SET', 'V1',  'I1'}; 
elseif handles.instr.measure_dc2
    indep_names = {'V2_SET', 'V2',  'I2'}; 
end
